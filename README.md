...
4. שאילתא: סדרות טלוויזיה עם אורך פרק ממוצע מעל 50 דקות
תיאור בעברית:
...
---
6. שאילתא: ניתוח הרכב התוכן של זכיינויות (Franchises) - כמות סרטים וסדרות
השאילתה מציגה עבור כל זכיינות את שמה, המספר הכולל של כותרים (סרטים וסדרות טלוויזיה), מספר הסרטים, ומספר סדרות הטלוויזיה השייכים לה.
![image](https://github.com/user-attachments/assets/1f71bb47-046e-4ba7-b9ae-9cb6bbdb22d3)

---
שאילתא 7: סדרות טלוויזיה עם עונות שהושלמו ומספר הפרקים הכולל שלהן
השאילתה מאתרת סדרות טלוויזיה שיש להן לפחות עונה אחת שסטטוסה הוא 'Completed' (בהנחה שזהו ערך קיים המציין סיום עונה). עבור כל סדרה כזו, היא מציגה את שם הסדרה, מספר העונות הכולל המוצהר, ואת סך כל הפרקים מכל העונות הרשומות במערכת.
![image](https://github.com/user-attachments/assets/caf970ac-4562-4eb4-b503-8a22d1f742b1)

---
שאילתא 8: כותרים מקוריים (שאינם המשכים) וכמות הפרסים שלהם
השאילתה מציגה כותרים (סרטים או סדרות) שאינם מהווים המשך לכותר אחר (כלומר, Sequel_ID הוא NULL). עבור כל כותר כזה, היא מציגה את שמו, דירוג הגיל שלו, את המספר הכולל של אזכורי פרסים (מועמדויות וזכיות), ואת מספר הפרסים בהם זכה בפועל (בהנחה שהערך 'Won' מציין זכייה).
![image](https://github.com/user-attachments/assets/e94f5fbc-6662-4c25-8de8-099d79bfbcec)
