...
בשלב ד' התמקדנו בהעשרת מערכת ניהול התוכן ביכולות לוגיקה עסקית מתקדמת על גבי בסיס הנתונים, באמצעות תכנות מתקדם ב־PL/pgSQL. פיתחנו פונקציות, פרוצדורות, טריגרים ותוכניות ראשיות שמיישמות עקרונות של תחזוקה אוטומטית, בקרת תקינות נתונים, ו־אוטומציה של תהליכים חזרתיים.

🔹 פונקציות (Functions) – כללנו פונקציות שמבצעות חישובים מורכבים כגון ניתוח סטטיסטיקות של יוצרים ועדכון מספר עונות בפועל.

🔹 פרוצדורות (Procedures) – יצרנו תהליכים מובנים לניהול פרנצ'ייזים ולעדכון סטטוס עונות בצורה חכמה ורציפה.

🔹 טריגרים (Triggers) – פיתחנו טריגרים המופעלים אוטומטית כדי לשמור על עקביות הנתונים, לדוגמה עדכון כמות כותרים בפרנצ'ייז או אימות חוזים לפני הוספה.

🔹 תוכניות ראשיות (Main Programs) – תוכניות שמבצעות סדרת פעולות בלחיצת כפתור – כגון עדכון סטטוס כולל או ניתוח יוצר + עדכון פרנצ'ייז, מה שמקל על ניהול המערכת השוטף.

🔹 בדיקות (Test Suite) – כללנו סקריפט בדיקה מקיף המדגים את תקינות כל הרכיבים שפותחו, כולל טיפול במקרים חריגים והצגת תוצאות למשתמש.

באמצעות כלים אלה, מערכת ניהול התוכן שלנו הפכה ממערכת סטטית למערכת דינמית, חכמה, מודולרית ותחזוקתית, אשר מסוגלת להתמודד עם שינויים ותהליכים מורכבים בצורה אוטומטית ובטוחה.
