...
1.  [**מבוא**](#מבוא)
    * [הצגת הפרויקט ומטרותיו](#הצגת-הפרויקט-ומטרותיו)

2.  [**שלב א' - תשתית בסיס הנתונים**](#שלב-א)
    * [פירוט הישויות](#פירוט-הישויות)
    * [תרשים ERD מקורי](#תרשים-erd-מקורי)
    * [תרשים DSD וטבלאות SQL](#תרשים-dsd-וטבלאות-sql)
    * [הזנת נתונים](#הזנת-נתונים)

3.  [**שלב ב' - שאילתות מתקדמות**](#שלב-ב)
    * [שאילתות `SELECT` מורכבות](#שאילתות-select-מורכבות)
    * [שאילתות `DELETE` מותנות](#שאילתות-delete-מותנות)
    * [שאילתות `UPDATE` מותנות](#שאילתות-update-מותנות)

4.  [**שלב ג' - אינטגרציה ומבטים (Views)**](#שלב-ג)
    * [הנדוס לאחור של מערכת נוספת](#הנדוס-לאחור)
    * [תהליך האינטגרציה](#תהליך-האינטגרציה)
    * [יצירת מבטים לניתוח נתונים](#יצירת-מבטים)

5.  [**שלב ד' - תכנות בסיס נתונים מתקדם**](#שלב-ד)
    * [פונקציות (`Functions`)](#פונקציות)
    * [פרוצדורות (`Procedures`)](#פרוצדורות)
    * [טריגרים (`Triggers`)](#טריגרים)
    * [תוכניות ראשיות ובדיקות](#תוכניות-ראשיות)

6.  [**שלב ה' - ממשק משתמש גרפי (GUI)**](#שלב-ה)
    * [דרישות והתקנה](#דרישות-והתקנה)
    * [הוראות הפעלה](#הוראות-הפעלה)
    * [כלים וטכנולוגיות](#כלים-וטכנולוגיות)
    * [מבנה האפליקציה](#מבנה-האפליקציה)

7.  [**סיכום כללי**](#סיכום-כללי)
    * [סיכום הישגי הפרויקט ומסקנות](#מסקנות)
