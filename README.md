...
5.  [**שלב ד' - תכנות בסיס נתונים מתקדם**](#שלב-ד---תכנות-בסיס-נתונים-מתקדם)
    ...
    * [סיכום שלב ד'](#סיכום-שלב-ד---תכנות-בסיס-נתונים-מתקדם)
6.  [**שלב ה' - ממשק משתמש גרפי (GUI)**](#שלב-ה---gui-עם-tkinter)
    * [דרישות והתקנה](#-דרישות-והתקנה)
    * [מבנה בסיס הנתונים](#-מבנה-בסיס-הנתונים)
    * [הוראות הפעלה](#️-הוראות-הפעלה)
    * [כלים וטכנולוגיות](#️-כלים-וטכנולוגיות)
    * [ממשק גרפי – מבנה האפליקציה](#️-ממשק-גרפי--מבנה-האפליקציה)
7.  [**סיכום כללי**](#סיכום-כללי)
    * [הישגים עיקריים](#הישגים-עיקריים)
---
